const DashboardIC = (props: any) => {
  return (
    ...
    >
      <rect width="18" height="18" fill="transparent" stroke="transparent" />
      <g id="My Company">
        <rect
          width="1440"
          height="1024"
          transform="translate(-518 -25)"
          fill={"transparent"}
        />
        <g id="Frame 1321315123">
          <g id="Frame 1321315122">
            <g id="Frame 1321315121">
              <g id="Frame 1321315116">
                <g id="vuesax/linear/element-4">
                  <g id="vuesax/linear/element-4_2">
                    <g id="element-4">
                      <path
                        id="Vector"
